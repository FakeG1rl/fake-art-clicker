...
var dlv_umd = __webpack_require__(905);
...
;// CONCATENATED MODULE: ./node_modules/@analytics/google-analytics/lib/analytics-plugin-ga.browser.es.js
// googleAnalytics events from a node server environment.

function analytics_plugin_ga_browser_es_defineProperty(obj, key, value) {
  if (key in obj) {
    Object.defineProperty(obj, key, {
      value: value,
      enumerable: true,
...
function _objectSpread(target) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function (key) {
      analytics_plugin_ga_browser_es_defineProperty(target, key, source[key]);
    });
  }
...
var init = (/* unused pure expression or super */ null && (googleAnalytics$1));
/* Standalone API */

var initialize$1 = (/* unused pure expression or super */ null && (undefined));
var page = (/* unused pure expression or super */ null && (undefined));
var track = (/* unused pure expression or super */ null && (trackEvent$1));
var identify = (/* unused pure expression or super */ null && (identifyVisitor$1));

/* harmony default export */ const analytics_plugin_ga_browser_es = (index);
...
var analytics = analyticsLib({
  ...
  plugins: [analytics_plugin_ga_browser_es({
...
var general_track = function track(name, category, label, value) {
    ...
    case ActionTypes/* PAINT */.yw:
      {
        ...
        if (newState.clicksDone >= newState.clicksToPainting && paintings.length < studioSize) {
          ...
          general_track('Painting created', 'game', 'game', 1);
        }
